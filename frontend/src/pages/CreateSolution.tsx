...
const CreateSolution = () => {
    ...
    (newFiles) => {
      ...
      setFiles((prev) => {
        ...
        solution.form.files.error =
          merged.length > solution.form.files.rules.max
  ...
  useEffect(() => {
    const updatedMarkdown = solution.form.description.value.replace(
      regex,
      (match, p1, p2) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={
                solution.form.annotation.error.length > 0
                  ? inputErrCls
                  : inputCls
              }
            />
          ...
          <div>
            ...
            <textarea
              ...
              className={
                solution.form.description.error.length > 0
                  ? inputErrCls
                  : inputCls
              }
            />
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              Поддерживаемые форматы: .zip, .png, .jpg, .jpeg, .gif, .pdf,
              .docx. Не более {solution.form.files.rules.max} файлов.
            </p>
          </div>
            ...
            <div className="p-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-5">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-3">
                  Конкурс «
                  {contest.currentContest?.title || "Неизвестный конкурс"}» от{" "}
                  {user.getById(contest.currentContest?.customer_id)?.login ||
                    "Неизвестно"}
                </p>
                ...
                {files.length > 0 && (
                  <>
                    ...
                    <ul className="space-y-1">
                      {files.map((file, idx) => (
                        <li key={idx} className="text-sm text-violet-600">
                          {file.name}
                        </li>
                      ))}
                    </ul>
          ...
          >
            <div className="p-6">
              ...
              <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                <p>
                  Название: от {solution.form.title.rules.min} до{" "}
                  {solution.form.title.rules.max} символов.
                </p>
                <p>
                  Аннотация: от {solution.form.annotation.rules.min} до{" "}
                  {solution.form.annotation.rules.max} символов.
                </p>
                <p>
                  Описание: от {solution.form.description.rules.min} до{" "}
                  {solution.form.description.rules.max} символов.
                </p>
                <p>
                  Файлы: zip-архивы и изображения, не более{" "}
                  {solution.form.files.rules.max} штук.
                </p>
                <p>
