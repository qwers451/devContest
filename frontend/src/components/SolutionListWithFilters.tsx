        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    {isMySolutions && (
                        <p className="text-gray-500 dark:text-gray-400 text-sm">Ваши отправленные работы</p>
                    )}
                </div>
            </div>
                        ...
                        <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
                            ...
                            <div className="flex items-center gap-2">
                                <select
                                    ...
                                    onChange={e => { solution.setSortBy(e.target.value); solution.fetchSolutionsFiltered(); }}
                                ...
                                <button
                                    onClick={() => { solution.setSortDir(solution.sortDir === 'desc' ? 'asc' : 'desc'); solution.fetchSolutionsFiltered(); }}
                                    ...
                                    title={solution.sortDir === 'desc' ? 'По убыванию' : 'По возрастанию'}
                                >
