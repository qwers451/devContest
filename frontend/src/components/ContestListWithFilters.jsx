        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
            ...
            <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Конкурсы</h1>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Найдите задачи, предложите лучшее решение и выиграйте приз</p>
                </div>
            </div>
                        ...
                        <div className="flex items-center justify-between mb-4 gap-3 flex-wrap">
                            ...
                            <div className="flex items-center gap-2">
                                <select
                                    ...
                                    onChange={e => { contest.setSortBy(e.target.value); contest.fetchContestsFiltered(1); }}
                                ...
                                <button
                                    onClick={() => { contest.setSortDir(contest.sortDir === 'desc' ? 'asc' : 'desc'); contest.fetchContestsFiltered(1); }}
                                    ...
                                    title={contest.sortDir === 'desc' ? 'По убыванию' : 'По возрастанию'}
                                >
