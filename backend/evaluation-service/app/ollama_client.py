...
- Отмечай is_critical: true если требование: функциональное (что должна делать система/работа), к формату или размеру файлов, к обязательным элементам (логотип, контакты, разделы и т.д.).
- Отмечай is_critical: false если требование: стилистическое (цвет, шрифт, стиль), рекомендательное ("желательно", "можно", "рекомендуется"), к структуре документа или оформлению.
