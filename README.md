...
Платформа конкурсного фриланса - заказчик создаёт конкурс, исполнители подают решения, сервис оценки проверяет соответствие ТЗ, платежный сервис ведёт кошелёк и эскроу.
